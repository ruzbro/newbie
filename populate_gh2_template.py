...
def populate_gh2_template():
    template_path = "/workspaces/newbie/data/GH2 Template - data gh2.csv"
    excel_path = "/workspaces/newbie/data/Hydronomics Monitoring NEW 2025.xlsx"
    sheet_name = 'Hydronomics GH2'
    output_filename = "/workspaces/newbie/data/Hydronomics Data gh2.csv"
