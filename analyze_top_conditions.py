...
# Filter for top performing weeks in GH3
...
# Analyze conditions for each top performing crop harvest
results = []
for index, row in top_weeks_analysis.iterrows():
...
print("Analysis of conditions for top performing weeks in GH3:")
